...
from qdecomp_scripts.train.run_experiments import _remove_by_path
from qdecomp_scripts.tune.helpers import dump_best_config
...
def study_status(study_dir: str):
    ...
    try:
        config_file, *_, constants = _get_study_config(study_file_path=f'qdecomp_scripts/tune/studies/{study.study_name}.py')
...
if __name__ == '__main__':
    """
    python qdecomp_scripts/tune/run_optuna.py optimize --study qdecomp_scripts/tune/studies/biaffine-graph-parser--transformer-encoder.py --load_if_exists --top 3
    ...
    """
    python qdecomp_scripts/tune/run_optuna.py status --study_dir tmp/tune_optuna/biaffine-graph-parser--transformer-encoder/
    """
    ...
    optimize_parser.add_argument('--study', type=str, help='a study to run (file of qdecomp_scripts/tune/studies)')
