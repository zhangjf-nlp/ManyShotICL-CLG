/*
PYTHONPATH=. CUDA_VISIBLE_DEVICES=0 nohup python qdecomp_scripts/train/run_experiments.py train --experiment experiments/hybrid/copynet--graph-embedder.jsonnet -s tmp/hybrid -o embedding_dim:300 > _logs/hybrid.txt &
*/
