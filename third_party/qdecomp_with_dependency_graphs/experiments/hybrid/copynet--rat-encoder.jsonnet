/*
PYTHONPATH=. CUDA_VISIBLE_DEVICES=0 nohup python qdecomp_scripts/train/run_experiments.py train --experiment experiments/hybrid/copynet--rat-encoder.jsonnet -s tmp/hybrid -o seed:13370 > _logs/hybrid.txt &
*/
