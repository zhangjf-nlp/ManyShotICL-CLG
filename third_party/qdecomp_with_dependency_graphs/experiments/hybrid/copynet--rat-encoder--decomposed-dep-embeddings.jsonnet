/*
nohup python qdecomp_scripts/train/run_experiments.py train --experiment experiments/hybrid/copynet--rat-encoder--decomposed-dep-embeddings.jsonnet -s tmp/rat-decomp -o seed:13370
*/
