/*
PYTHONPATH=. CUDA_VISIBLE_DEVICES=0 nohup python qdecomp_scripts/train/run_experiments.py train --experiment experiments/hybrid/copynet--transformer-encoder--graph-embedder.jsonnet -s tmp/hybrid -o embedding_dim:768 seed:13370 num_epochs:25 > _logs/hybrid.txt &
*/
