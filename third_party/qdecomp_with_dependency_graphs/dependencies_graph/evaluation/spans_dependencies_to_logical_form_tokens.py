...
from qdecomp_scripts.qdmr_to_logical_form.operator_identifier import ArgumentType
from qdecomp_scripts.qdmr_to_logical_form.qdmr_identifier import QDMRStep, QDMROperator, get_identifier
